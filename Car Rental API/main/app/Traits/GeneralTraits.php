...
class GeneralTraits
{
    ...
    public static function returnError($codeNum, $msg){
    ...
    public static function returnValidationError($codeNum, $validator)
    {
        return GeneralTraits::returnError($codeNum, $validator->errors()->first());
    }
    ...
    public static function returnCodeAccordingToInput($validator)
    {
        ...
        $code = GeneralTraits::getErrorCode($inputs[0]);
        return $code;
    }
